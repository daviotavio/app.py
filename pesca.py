...
peso = int(input('Quantos quilos de peixe foram trazidos? '))
...
print('A quantidade de quilos de peixe foi {0}, e o excesso {1}, logo a multa aplicada será de R$:{2} '.format(peso, excesso, multa))
